...
<div class="card shadow-lg border-0 mb-3">
    ...
    <div class="card-body">
        <form method="post" action="{{ route('app.users.store') }}" class="row g-3">
            @csrf
                ...
                <tr>
                    ...
                    <td>
                        <div class="table-actions">
                            <button class="btn btn-sm btn-warning" type="button" data-bs-toggle="modal" data-bs-target="#editUserModal{{ $u->id }}">
