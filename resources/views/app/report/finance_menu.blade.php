...
@section('title', 'Rekap Keuangan Menu - Sakina Kantin')
@section('page_title', 'Laporan Rekap Keuangan Menu')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('/app/home') }}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Rekap Keuangan Menu</li>
    </ol>
</nav>
@endsection

@section('content')
{{-- Toolbar filter + export rekap keuangan per menu --}}
<div class="card shadow-lg border-0 mb-3">
    <div class="card-header bg-dark text-white fw-bold">
        <i class="bi bi-list-columns-reverse me-2"></i>Rekap Keuangan per Menu
    </div>
    <div class="card-body">
        <form method="get" class="row g-2 align-items-end legacy-form-compact">
            ...
            <div class="col-auto d-flex gap-2">
                ...
                <a class="btn btn-outline-primary" href="{{ route('app.reports.finance_menu.export', request()->query()) }}"><i class="bi bi-download me-1"></i>Export Excel</a>
                <a class="btn btn-outline-danger" href="{{ route('app.reports.finance_menu.export', array_merge(request()->query(), ['format' => 'pdf'])) }}"><i class="bi bi-file-earmark-pdf me-1"></i>Export PDF</a>
            </div>
        </form>
...
{{-- Tabel agregasi keuangan per menu --}}
<div class="card shadow-lg border-0">
    <div class="card-body table-responsive">
        <table class="table table-striped table-hover table-bordered caption-top align-middle js-datatable legacy-report-table">
            <caption class="fw-bold">Daftar Rekap Keuangan Menu</caption>
            <thead>
            <tr class="table-head-soft">
                <th>No</th><th>Nama Menu</th><th>Jumlah</th><th>Nama Toko</th><th>Harga Jual</th><th>PPN</th><th>Harga Pembeli</th><th>Total Menu</th><th>Total PPN</th><th>Total Pembeli</th><th>Untung Toko</th><th>Untung RS</th><th>Untung RS + Pajak</th>
            </tr>
            </thead>
            <tbody>
