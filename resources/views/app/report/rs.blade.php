...
@section('title', 'Laporan Kantin Detail - Sakina Kantin')
@section('page_title', 'Laporan Pendapatan Kantin Detail')
@section('breadcrumb')
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="{{ url('/app/home') }}">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">Laporan Pendapatan Kantin Detail</li>
    </ol>
</nav>
@endsection
...
@section('content')
{{-- Toolbar filter + export laporan pendapatan kantin --}}
<div class="card report-page-section shadow-lg border-0 mb-3 report-filter-toolbar">
    <div class="card-header fw-bold">
        <i class="bi bi-fork-knife me-2"></i>Laporan Pendapatan Kantin Detail
    </div>
    <div class="card-body">
        <form method="get" class="row g-2 align-items-end legacy-form-compact js-report-filter" data-loading-target="rsReportLoading">
            ...
            <div class="col-auto d-flex gap-2">
                ...
                <a class="btn btn-outline-primary" href="{{ route('app.reports.rs.export', request()->query()) }}"><i class="bi bi-download me-1"></i>Export Excel</a>
                <a class="btn btn-outline-danger" href="{{ route('app.reports.rs.export', array_merge(request()->query(), ['format' => 'pdf'])) }}"><i class="bi bi-file-earmark-pdf me-1"></i>Export PDF</a>
            </div>
        </form>
...
{{-- Tabel laporan pendapatan kantin + total --}}
<div class="card report-page-section shadow-lg border-0 position-relative">
    <div class="report-loading-overlay" id="rsReportLoading" aria-hidden="true">
    ...
    <div class="card-body table-responsive">
        <table class="table table-striped table-hover table-bordered caption-top align-middle js-datatable">
            <caption class="fw-bold">Daftar Pendapatan Kantin Detail</caption>
            <thead><tr class="table-head-soft"><th>No</th><th>Kode</th><th>Pelanggan</th><th>Meja</th><th>Pendapatan Sakina Food Court</th><th>Waktu Order</th><th>Nama Toko</th></tr></thead>
            <tbody>
