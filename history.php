...
if (isset($_POST['filter'])) {
    ...
    $query_string = "SELECT tb_order.waktu_order, tb_menu.nama, sum(tb_list_order.jumlah) AS Total_Terjual, tb_menu.harga AS harga_satuan, SUM(tb_list_order.jumlah)*tb_menu.harga as Total_harga, tb_menu.nama_toko 
                    FROM tb_order
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="mb-3">
                        <form method="POST" action="excel_export/export_excel_menu.php" target="_blank">
