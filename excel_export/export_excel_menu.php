...
$sql = "SELECT tb_menu.nama, sum(tb_list_order.jumlah) AS Total_Terjual, tb_menu.harga AS harga_satuan, SUM(tb_list_order.jumlah)*tb_menu.harga as Total_harga, tb_menu.nama_toko 
        FROM tb_order
...
$sheet->setCellValue('A1', 'LAPORAN REKAPITULASI PENJUALAN PER MENU');
